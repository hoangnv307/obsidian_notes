...
- Trong trường hợp này, bởi vì sự coupling giữa range-azimuth, FM rate của range matched-filter trong miền range-Doppler nên có giá trị $K_m$ thay vì giá trị gốc $K_r$, với $K$
