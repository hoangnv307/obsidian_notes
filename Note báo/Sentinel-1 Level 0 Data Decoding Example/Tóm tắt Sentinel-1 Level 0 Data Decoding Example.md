...
- Nhìn chung, Tác giả định nghĩa, một acquisition chunk là một tập các Space Packet liên tiếp thỏa mãn đồng thời các điều kiện sau: 
	- Signal Type không đổi
	- Swath Number không đổi
	- Number of Quads không đổi
	- BAQ Mode không đổi
	- SWST không đổi
	- SWL không đổi
	- PRI không đổi
	- PRI Count tăng đúng 1 qua từng packet 
	- Azimuth Beam Address tăng đơn điêu. 
	- Elevation Beam Address không đổi
```python
